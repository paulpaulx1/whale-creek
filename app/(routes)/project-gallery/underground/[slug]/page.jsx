// app/project-gallery/underground/[slug]/page.jsx
import Link from "next/link";
import { notFound } from "next/navigation";
import { client } from "../../../../lib/sanity";
import { PortableText } from "@portabletext/react";
import MasonryGallery from "../../[slug]/MasonryGallery.client";
import styles from "./UndergroundProject.module.css";

const projectQuery = `
  *[_type == "project" && slug.current == $slug && category == "underground"][0]{
    _id,
    title,
    slug,
    category,
...
export default async function UndergroundProjectPage({ params }) {
  const { slug } = await params;
  const project = await getProject(slug);
  ...
  return (
    <main className={styles.main}>
      <div className={styles.wrapper}>
        <Link href="/project-gallery/underground" className={styles.backLink}>
          ← Underground
        </Link>
        ...
        <aside className={styles.sidebar}>
          <div className={styles.sidebarContent}>
            <p className={styles.eyebrow}>Whale Creek Underground</p>
