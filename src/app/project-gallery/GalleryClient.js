  ...
  return (
    <>
      ...
      <div className={styles.kineticBg}>
        ...
        <div className={`${styles.floatingElement} ${styles.floatCircle}`}></div>
        <div className={`${styles.floatingElement} ${styles.floatSquare}`}></div>
        <div className={`${styles.floatingElement} ${styles.floatBeam}`}></div>
      </div>
        ...
        <section className={styles.hero}>
          <div className={styles.heroContainer}>
            <div className={styles.heroContent}>
              <h1>
                PROJECT <span className={styles.heroAccent}>GALLERY</span>
              </h1>
              <p>
                Discover our latest custom millwork, residential construction, 
                and commercial projects that showcase our commitment to 
                geometric excellence and Scandinavian craftsmanship.
              </p>
                    ...
                    <div className={styles.featuredImage}>
                      {project.images && project.images[0] && project.images[0].asset?.asset ? (
                        ...
                        <div className={styles.placeholderImage}>
                          <i className="ph ph-image" style={{ fontSize: '4rem', color: '#37474F', opacity: 0.3 }}></i>
            ...
            {filteredProjects.length === 0 ? (
              <div className={styles.emptyState}>
                <div className={styles.emptyIcon}>
                  <i className="ph ph-folder-open" style={{ fontSize: '4rem', color: '#37474F', opacity: 0.5 }}></i>
                </div>
                  ...
                  <div key={project._id} className={styles.projectCard}>
                    <div className={styles.projectImage}>
                      {project.images && project.images[0] && project.images[0].asset?.asset ? (
                        ...
                        <div className={styles.placeholderImage}>
                          <i className="ph ph-image" style={{ fontSize: '3rem', color: '#37474F', opacity: 0.3 }}></i>
